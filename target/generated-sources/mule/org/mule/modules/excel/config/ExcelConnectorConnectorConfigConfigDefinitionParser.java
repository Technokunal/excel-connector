...
import org.mule.modules.excel.adapters.ExcelConnectorConnectorConfigBasicAdapter;
...
public class ExcelConnectorConnectorConfigConfigDefinitionParser
    extends AbstractDevkitBasedDefinitionParser
{

    private static Logger logger = LoggerFactory.getLogger(ExcelConnectorConnectorConfigConfigDefinitionParser.class);
    ...
    public BeanDefinition parse(Element element, ParserContext parserContext) {
        ...
        setInitMethodIfNeeded(builder, ExcelConnectorConnectorConfigBasicAdapter.class);
        setDestroyMethodIfNeeded(builder, ExcelConnectorConnectorConfigBasicAdapter.class);
    ...
    private BeanDefinitionBuilder getBeanDefinitionBuilder(ParserContext parserContext) {
        try {
            return BeanDefinitionBuilder.rootBeanDefinition(ExcelConnectorConnectorConfigBasicAdapter.class.getName());
