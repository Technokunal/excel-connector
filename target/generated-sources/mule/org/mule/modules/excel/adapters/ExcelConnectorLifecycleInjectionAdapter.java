...
/**
 * A <code>ExcelConnectorLifecycleInjectionAdapter</code> is a wrapper around {@link ExcelConnector } that adds lifecycle methods to the pojo. This adapter also allows the injection of several Mule facilities when a MuleContext is set.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.7.1", date = "2015-12-02T05:50:09-08:00", comments = "Build UNNAMED.2613.77421cc")
public class ExcelConnectorLifecycleInjectionAdapter
    extends ExcelConnectorMetadataAdapter
    implements MuleContextAware, Disposable, Initialisable, Startable, Stoppable
{
    ...
    {
        Logger log = LoggerFactory.getLogger(ExcelConnectorLifecycleInjectionAdapter.class);
